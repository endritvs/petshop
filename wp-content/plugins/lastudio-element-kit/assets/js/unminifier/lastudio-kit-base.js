    ...
    var LaStudioKits = {
        ...
        hamburgerPanel: function ($scope) {
            ...
            if($scope.closest('.elementor-location-header').length){
                $(document.createElement('div')).addClass('elementor-element elementor-element-' + wid).append($scope.find('>.elementor-widget-container').clone()).appendTo($burger_wrap_all);
