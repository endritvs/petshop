...
class LaStudioKit_Instagram_Feed extends LaStudioKit_Base {
    ...
    protected function enqueue_addon_resources(){
	    ...
	    if(!lastudio_kit_settings()->is_combine_js_css()) {
		    wp_register_style( $this->get_name(), lastudio_kit()->plugin_url( 'assets/css/addons/instagram-feed.css' ), [ 'lastudio-kit-base' ], lastudio_kit()->get_version() );
    ...
    public function get_icon() {
        return 'lastudio-kit-icon-instagram';
    }
