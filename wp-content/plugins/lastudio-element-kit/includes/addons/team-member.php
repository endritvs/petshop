...
class LaStudioKit_Team_Member extends LaStudioKit_Base {
    ...
    protected function register_controls() {
        ...
        $css_scheme = apply_filters(
            'lastudio-kit/team-member/css-scheme',
            array(
        ...
        $this->add_control(
            'img_overlay',
            array(
                'label'  => esc_html__( 'Bg Overlay', 'lastudio-kit' ),
                'type'   => Controls_Manager::COLOR,
                'selectors' => array(
                    '{{WRAPPER}} .lakit-team-member__link:after' => 'background-color: {{VALUE}}',
                ),
            )
        );
        ...
        $this->add_control(
            ...
            array(
                ...
                'type'   => Controls_Manager::COLOR,
                'selectors' => array(
                    '{{WRAPPER}} .lakit-team-member__inner:hover .lakit-team-member__link:after' => 'background-color: {{VALUE}}',
                ),
            )
        );
        ...
        $this->add_control('social_bg_color', array(
                'label' => esc_html__('Bg Color', 'lastudio-kit'),
                'type' => Controls_Manager::COLOR,
                'selectors' => array(
