    ...
    protected function register_controls() {
        ...
        $this->_add_responsive_control(
            ...
            array(
                ...
                'size_units' => array( 'px', '%', 'em', 'vw', 'vh' ),
                'selectors'  => array(
                    '{{WRAPPER}} .lakit-product-tabs .wc-tabs-wrapper .lakit-wc-tabs--controls ul.wc-tabs li' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
    ...
    protected function render() {
        ...
        if ( wp_doing_ajax() ) {
            ...
            <script>
                ...
                jQuery(document).trigger('lastudiokit/woocommerce/single/product-tabs');
            </script>
            <?php
        }
    }
